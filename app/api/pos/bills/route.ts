...
export async function GET(request: Request) {
  ...
  let query = admin
    ...
    .select(`
      ...
      subtotal, discount_amount, public_discount_amount, total_amount, amount_due, advance_paid, points_redeemed, points_redeemed_online,
      finalized_at, created_at,
      items:order_items(id, table_id, status, actual_start, actual_end, checked_in_at, scheduled_start, scheduled_end, expected_end, rate_per_hour, final_amount, num_people, table:tables(name, type)),

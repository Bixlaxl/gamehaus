...
export function OrderPanel({ locationId }: OrderPanelProps) {
    ...
    return (
      <div className="h-full flex items-center justify-center bg-gray-50 dark:bg-[#0a0a0a]">
        <div className="text-center px-8 space-y-3">
          ...
          <p className="text-sm text-gray-400 dark:text-[#444] leading-relaxed">
            Tap a live table to manage the session,<br />or start a new walk-in.
          </p>
        </div>
      </div>
    );
  ...
  async function stopSession(item: OrderItem) {
    ...
    // Optimistically mark finished — UI reacts instantly
    store.patchOrderItem(item.id, { status: "finished", actual_end: now });
    ...
    <div className="h-full flex flex-col overflow-hidden bg-gray-50 dark:bg-[#0a0a0a]">
      ...
      <div className="flex-1 overflow-y-auto px-5 py-5 space-y-4 min-w-0">
        ...
        <div className="flex items-center justify-between px-4 py-3 rounded-2xl bg-white dark:bg-[#111] border border-gray-100 dark:border-[#1f1f1f] shadow-sm">
          ...
          <span
            className="shrink-0 text-[10px] font-bold px-2 py-0.5 rounded-full uppercase tracking-wide ml-3"
            style={
            ...
            >
              ...
              <div className="flex items-start justify-between gap-3">
                ...
                <div className="text-right shrink-0">
                  <p
                    className="font-bold text-base tabular-nums text-gray-900 dark:text-white"
                    style={isRunning ? { color: "#D4541A" } : undefined}
                  >
                ...
                <div className="flex items-center justify-between px-3 py-2 rounded-lg bg-gray-50 dark:bg-[#0a0a0a] border border-gray-100 dark:border-[#1a1a1a]">
                  ...
                  <div className="flex items-center gap-1.5">
                    {showHandover ? (
                      ...
                      <>
                        <span className="text-[10px] text-gray-400 dark:text-[#444] uppercase tracking-wide">Left</span>
              ...
              {isRunning && (
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex items-center justify-center gap-1.5 px-4 py-2 rounded-lg text-white text-xs font-bold transition-colors hover:bg-red-500 active:bg-red-700"
                  ...
                  {!hasNextBooking && (
                    <button
                      ...
                      className="flex items-center gap-1.5 px-4 py-2 rounded-lg text-xs font-semibold transition-colors
                        ...
                        text-gray-600 dark:text-[#888] hover:text-gray-900 dark:hover:text-white hover:border-gray-400 dark:hover:border-[#444]"
                    >
              ...
              {item.status === "scheduled" && (
                <button
                  className="w-full py-2 rounded-lg text-white text-xs font-bold flex items-center justify-center gap-1.5 transition-colors hover:bg-emerald-400 active:bg-emerald-600"
        ...
        <div className="rounded-2xl overflow-hidden bg-white dark:bg-[#111] border border-gray-100 dark:border-[#1f1f1f] shadow-sm">
          ...
          <div className="p-3 space-y-1">
            {activeExtras.length === 0 && !addExtraOpen && (
              <p className="text-xs py-1.5 text-gray-400 dark:text-[#444]">
                None added
              </p>
            )}
              ...
              <div key={extra.id} className="flex items-center justify-between py-1 px-1">
                ...
                <div className="flex items-center gap-2.5 shrink-0">
                  ...
                  <button
                    ...
                    className="text-gray-400 dark:text-[#444] hover:text-red-400 transition-colors"
                  >
